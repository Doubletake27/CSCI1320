...
const int D = 3;  // This is test
// const int M = 7732; // This is for AllWords
// const int M = 7682; // This is for CleanedWords

void sortArr(wordPairs arr[][D], long int len); // Initalizing Sort function
int isUnique(wordPairs list[][D], long int len, string word1, string word2); // This needs to be a pass by reference
...
int main(){
  ...
  // Creates Indexing Array
  // This will come from either "sortedAllWords.txt" or "sortedClean Works.txt"


  // Create 2D array to replace the array of structs
  wordBank2D[][]; // Line 1 will be the first word, Line
